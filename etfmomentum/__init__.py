...
Generates momentum-based ETF rotation signals across five universes
(sp500, developed, emerging, commodity, multi_asset) using relative strength
vs SPY, dual SMA filters, and SGOV cash protection.
...
Usage:
    ...
    etfs = run_signals('multi_asset')  # e.g. ['QQQ', 'GLD', 'TLT', 'SPY', 'IWM']
...
CLI:
    ...
    etfmomentum signal --universe multi_asset
    etfmomentum backtest --universe multi_asset
"""
